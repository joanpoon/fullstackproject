...
<header class="headstyle">
    <section>
            <div class="btn-group">
                ...
                <button onclick="location.href='/airplane/tracker?cmd=register'" type="button">Register</button>
                <button onclick="location.href='/airplane/tracker?cmd=login'" type="button">Log In</button>
